    ...
    <div className="max-w-4xl mx-auto mt-8 p-6 bg-white rounded-lg shadow-lg border border-gray-200">
      ...
      <div className="mb-6">
        <input
          ...
          className="w-full p-3 text-gray-800 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 placeholder-gray-500"
          value={searchTerm}
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
        {filteredTeams.map((team) => (
          <button
            ...
            className="p-3 text-center border border-gray-200 rounded-lg hover:bg-blue-400 hover:text-white transition-colors duration-200 flex flex-col items-center gap-2"
          >
